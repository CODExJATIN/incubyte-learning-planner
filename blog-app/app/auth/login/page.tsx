...
export default function LoginPage() {
  ...
  return (
    <div className="relative max-w-md mx-auto mt-24">
      {/* Decorative background glow */}
      <div className="absolute -inset-1 bg-gradient-to-r from-primary to-primary-light rounded-3xl blur opacity-20" />
      
      <div className="relative p-8 glass rounded-3xl border border-white/20 shadow-2xl">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-text-primary to-text-secondary drop-shadow-sm mb-2 text-glow">
            Welcome Back
          </h1>
        ...
        {state?.error && (
          <div className="mb-6 p-4 bg-danger/10 text-danger border border-danger/20 rounded-xl text-sm font-medium animate-pulse">
            🚨 {state.error}
          </div>
        )}
        ...
        <p className="mt-8 text-center text-sm text-text-secondary">
          ...
          <Link href="/auth/signup" className="text-primary hover:text-primary-hover font-bold transition-colors">
            Sign up ✨
          </Link>
        </p>
      </div>
